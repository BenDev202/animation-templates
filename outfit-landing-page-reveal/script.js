...
CustomEase.create("hop", "0.6, 0, 0.2, 1");
...
// 2. Reveal Preloader Title (Random character stagger)
tl.to(
...
// 3. Reveal Counter and Value Animation
tl.to(
  ".preloader-counter p",
  {
    y: "0%",
...
// 4. Exit Animation (Counter, Title, Images)
tl.to(
  ".preloader-counter p",
  {
    y: "-100%",
...
// 5. Reveal Hero Section (Preloader ClipPath collapse)
tl.to(
  ".preloader",
  {
